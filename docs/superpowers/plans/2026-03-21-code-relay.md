...
**Architecture:** All-Swift monorepo. Raw SwiftNIO WebSocket server with actor-based concurrency. Shared `CodeRelayKit` for protocol types. CLI via Swift Argument Parser. iOS app with SwiftTerm terminal emulation.
...
└── CodeRelayApp/                           # iOS Xcode project
    ├── CodeRelayApp.xcodeproj/
    └── CodeRelayApp/
        ├── CodeRelayAppApp.swift           # App entry point
        ├── Views/
...
- `Sources/CodeRelayKit/CodeRelayKit.swift` — `// placeholder`
- `Sources/CodeRelayServer/main.swift` — `@main struct Server { static func main() {} }`
- `Sources/CodeRelayCLI/main.swift` — `import ArgumentParser; @main struct CLI: ParsableCommand { func run() {} }`
- `Sources/CodeRelayClient/CodeRelayClient.swift` — `// placeholder`
...
## Task 2: Protocol Message Types (CodeRelayKit)

**Files:**
- Create: `Sources/CodeRelayKit/Protocol/ClientMessage.swift`
- Create: `Sources/CodeRelayKit/Protocol/ServerMessage.swift`
- Create: `Sources/CodeRelayKit/Protocol/MessageEnvelope.swift`
- Test: `Tests/CodeRelayKitTests/ProtocolMessageTests.swift`
...
```swift
// Sources/CodeRelayKit/Protocol/ClientMessage.swift
import Foundation
...
```swift
// Sources/CodeRelayKit/Protocol/ServerMessage.swift
import Foundation
...
```swift
// Sources/CodeRelayKit/Protocol/MessageEnvelope.swift
import Foundation
...
## Task 3: Session State Model (CodeRelayKit)

**Files:**
- Create: `Sources/CodeRelayKit/Models/SessionState.swift`
- Create: `Sources/CodeRelayKit/Models/SessionInfo.swift`
- Test: `Tests/CodeRelayKitTests/SessionStateTests.swift`
...
```swift
// Sources/CodeRelayKit/Models/SessionState.swift
...
```swift
// Sources/CodeRelayKit/Models/SessionInfo.swift
import Foundation
...
## Task 4: Token Model + Generator (CodeRelayKit)

**Files:**
- Create: `Sources/CodeRelayKit/Models/TokenInfo.swift`
- Create: `Sources/CodeRelayKit/Security/TokenGenerator.swift`
- Test: `Tests/CodeRelayKitTests/TokenGeneratorTests.swift`
...
```swift
// Sources/CodeRelayKit/Models/TokenInfo.swift
import Foundation
...
```swift
// Sources/CodeRelayKit/Security/TokenGenerator.swift
import Foundation
import Crypto
...
## Task 5: Configuration Model (CodeRelayKit)

**Files:**
- Create: `Sources/CodeRelayKit/Models/RelayConfig.swift`
...
```swift
// Sources/CodeRelayKit/Models/RelayConfig.swift
import Foundation
...
**Files:**
- Create: `Sources/CodeRelayServer/Services/RingBuffer.swift`
- Test: `Tests/CodeRelayServerTests/RingBufferTests.swift`
...
```swift
// Sources/CodeRelayServer/Services/RingBuffer.swift
...
**Files:**
- Create: `Sources/CodeRelayServer/Actors/TokenStore.swift`
- Test: `Tests/CodeRelayServerTests/TokenStoreTests.swift`
...
**Files:**
- Create: `Sources/CodeRelayServer/Actors/PTYSession.swift`
...
```swift
// Sources/CodeRelayServer/Actors/PTYSession.swift
import Foundation
import CPTYShim
import NIOCore
...
**Files:**
- Create: `Sources/CodeRelayServer/Actors/SessionManager.swift`
- Test: `Tests/CodeRelayServerTests/SessionManagerTests.swift`
...
```swift
// Sources/CodeRelayServer/Actors/SessionManager.swift
...
**Files:**
- Create: `Sources/CodeRelayServer/Network/WebSocketServer.swift`
- Create: `Sources/CodeRelayServer/Network/RelayMessageHandler.swift`
...
```swift
// Sources/CodeRelayServer/Network/WebSocketServer.swift
import NIO
import NIOHTTP1
import NIOWebSocket
...
```swift
// Sources/CodeRelayServer/Network/RelayMessageHandler.swift
import NIO
import NIOWebSocket
import CodeRelayKit
...
**Files:**
- Create: `Sources/CodeRelayServer/Network/AdminHTTPServer.swift`
- Create: `Sources/CodeRelayServer/Network/AdminRoutes.swift`
- Create: `Sources/CodeRelayServer/Services/ConfigManager.swift`
- Test: `Tests/CodeRelayServerTests/AdminRoutesTests.swift`
...
**Files:**
- Modify: `Sources/CodeRelayServer/main.swift`
...
```swift
// Sources/CodeRelayServer/main.swift
import NIO
import CodeRelayKit

@main
struct CodeRelayServer {
    static func main() async throws {
        ...
        print("CodeRelay server running")
...
**Files:**
- Modify: `Sources/CodeRelayCLI/main.swift`
- Create: `Sources/CodeRelayCLI/CLIRoot.swift`
- Create: `Sources/CodeRelayCLI/Formatters/OutputFormatter.swift`
- Create: `Sources/CodeRelayCLI/AdminClient.swift`
- Test: `Tests/CodeRelayCLITests/OutputFormatterTests.swift`
...
**Files:**
- Create: `Sources/CodeRelayCLI/Commands/ServiceCommands.swift`
...
**Files:**
- Create: `Sources/CodeRelayCLI/Commands/TokenCommands.swift`
...
**Files:**
- Create: `Sources/CodeRelayCLI/Commands/SessionCommands.swift`
- Create: `Sources/CodeRelayCLI/Commands/ConfigCommands.swift`
- Create: `Sources/CodeRelayCLI/Commands/LogCommands.swift`
...
**Files:**
- Create: `Sources/CodeRelayClient/ConnectionConfig.swift`
- Create: `Sources/CodeRelayClient/AuthManager.swift`
...
**Files:**
- Create: `Sources/CodeRelayClient/RelayConnection.swift`
- Create: `Sources/CodeRelayClient/SessionController.swift`
...
**Files:**
- Create: `Sources/CodeRelayClient/TerminalBridge.swift`
...
**Files:**
- Create: `CodeRelayApp/` Xcode project structure
- Create: `CodeRelayApp/CodeRelayApp/CodeRelayAppApp.swift`
- Create: `CodeRelayApp/CodeRelayApp/Views/ConnectionView.swift`
- Create: `CodeRelayApp/CodeRelayApp/Views/SessionListView.swift`
- Create: `CodeRelayApp/CodeRelayApp/Views/TerminalContainerView.swift`
- Create: `CodeRelayApp/CodeRelayApp/Views/Components/StatusIndicator.swift`
- Create: `CodeRelayApp/CodeRelayApp/Views/Components/KeyboardAccessory.swift`
- Create: `CodeRelayApp/CodeRelayApp/ViewModels/ConnectionViewModel.swift`
- Create: `CodeRelayApp/CodeRelayApp/ViewModels/SessionListViewModel.swift`
- Create: `CodeRelayApp/CodeRelayApp/ViewModels/TerminalViewModel.swift`
...
Create the directory structure. Use `swift package init --type executable` in `CodeRelayApp/` or scaffold manually. Add `SwiftTerm` dependency.
