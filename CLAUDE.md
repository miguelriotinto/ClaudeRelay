...
This project is indexed by GitNexus as **Claude Relay** (268 symbols, 2284 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/Claude Relay/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Claude Relay/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Claude Relay/clusters` | All functional areas |
| `gitnexus://repo/Claude Relay/processes` | All execution flows |
| `gitnexus://repo/Claude Relay/process/{name}` | Step-by-step execution trace |
